...
autoencoder.add(tf.keras.layers.Conv1D(64, kernel_size=3, activation='relu', input_shape=(length, num_features)))
autoencoder.add(tf.keras.layers.Conv1D(32, kernel_size=3,activation='relu'))
autoencoder.add(tf.keras.layers.Conv1D(16, kernel_size=3,activation='relu'))
autoencoder.add(tf.keras.layers.Conv1D(8,kernel_size=3, activation='relu'))
autoencoder.add(tf.keras.layers.Conv1D(latent_vector, kernel_size = 1, activation = 'relu'))
# Decoder
autoencoder.add(tf.keras.layers.Conv1D(8,kernel_size= 3,activation='relu'))
autoencoder.add(tf.keras.layers.Conv1D(16,kernel_size= 3,activation='relu'))
autoencoder.add(tf.keras.layers.Conv1D(32, kernel_size=3,activation='relu'))
autoencoder.add(tf.keras.layers.Conv1D(64,kernel_size= 3,activation='relu'))
autoencoder.add(tf.keras.layers.Dense(num_features))
