...
batch = 40
lr = 0.001
sequence_length = 60 # 작게 설정
num_features = 30
num_classes = 2
pass_frames = 3 # 넘기는 개수(4개에 한번 씩)
...
autoencoder.add(tf.keras.layers.LSTM(128, activation='relu', input_shape=(length, num_features), return_sequences=True))
...
autoencoder.add(tf.keras.layers.RepeatVector((sequence_length//pass_frames)))
# Decoder
