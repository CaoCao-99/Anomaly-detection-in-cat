...
# Encoder
length = sequence_length//pass_frames
autoencoder.add(tf.keras.layers.LSTM(64, activation='relu', input_shape=(length, num_features), return_sequences=True))
autoencoder.add(tf.keras.layers.LSTM(32, activation='relu', return_sequences=False))
# autoencoder.add(tf.keras.layers.LSTM(16, activation='relu', return_sequences=False))
# autoencoder.add(tf.keras.layers.LSTM(8, activation='relu', return_sequences=False))
autoencoder.add(tf.keras.layers.RepeatVector(length))
# Decoder
# autoencoder.add(tf.keras.layers.LSTM(8, activation='relu', return_sequences=True))
# autoencoder.add(tf.keras.layers.LSTM(16, activation='relu', return_sequences=True))
autoencoder.add(tf.keras.layers.LSTM(32, activation='relu', return_sequences=True))
autoencoder.add(tf.keras.layers.LSTM(64, activation='relu', return_sequences=True))
autoencoder.add(tf.keras.layers.TimeDistributed(layers.Dense(num_features)))
