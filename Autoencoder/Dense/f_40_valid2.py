...
# Encoder
autoencoder.add(tf.keras.layers.Dense(64, activation='relu', input_shape=(sequence_length//pass_frames, num_features)))
autoencoder.add(tf.keras.layers.Dense(32, activation='relu'))
autoencoder.add(tf.keras.layers.Dense(16, activation='relu'))
autoencoder.add(tf.keras.layers.Dense(1, activation='relu')) #8개로 줄이긴
# Decoder
autoencoder.add(tf.keras.layers.Dense(16, activation='relu'))
autoencoder.add(tf.keras.layers.Dense(32, activation='relu'))
