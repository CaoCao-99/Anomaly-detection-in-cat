...
fold = ['cat_limping_refined', 'Cat_Sneezing', 'cat_throwing_up_refined', 'throwing-up']
...
for class_name in fold :
    ...
    video_folder = os.path.join('/home/sm32289/Cat_Pose/KeypointDetection_Yolo/Test_video_30/Abnormal',class_name)
    video_files = [f for f in os.listdir(video_folder) if f.endswith('.mp4')]
    remove_videos = []
    change_videos = []
    predict_dir = '/home/sm32289/Cat_Pose/KeypointDetection_Yolo/predict2/Abnormal' 
    ...
    for video_file in video_files:
        ...
        if is_video_lower_one_hour(video_path):
            ...
            if not os.path.exists(key_save_dir):
                results = model(source=video_path, conf=0.8, save=True, project=predict_video_path, name = output_video_file)         
